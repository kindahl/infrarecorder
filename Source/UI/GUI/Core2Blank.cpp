...
{
	g_LogDlg.AddLine(_T("CCore2Blank::Blank"));
	...
	switch (iMethod)
	{
		...
		default:
			g_LogDlg.AddLine(_T("  Warning: Unknown erase method, using full erase."));
			ucBlankType = 0x00;
			break;
	}
	...
	{
		g_LogDlg.AddLine(_T("  Error: Failed to handle events, handled events: 0x%.2X"),ucEvents);
		return false;
	}
