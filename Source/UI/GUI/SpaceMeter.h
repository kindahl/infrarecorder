...
// Normal colors.
/*#define SPACEMETER_BORDERCOLOR				RGB(0,102,204)
#define SPACEMETER_BARCOLOR_FREETOP			RGB(204,204,255)
#define SPACEMETER_BARCOLOR_FREEBOTTOM		RGB(255,255,255)
#define SPACEMETER_BARCOLOR_TOP				RGB(204,204,255)
#define SPACEMETER_BARCOLOR_BOTTOM			RGB(64,154,222)

// Warning colors (when overburning will most probably work).
#define SPACEMETER_WARNBORDERCOLOR			RGB(255,153,51)
#define SPACEMETER_WARNBARCOLOR_FREETOP		RGB(255,231,189)
#define SPACEMETER_WARNBARCOLOR_FREEBOTTOM	RGB(255,255,255)
#define SPACEMETER_WARNBARCOLOR_TOP			RGB(255,219,157)
#define SPACEMETER_WARNBARCOLOR_BOTTOM		RGB(255,204,102)

// Disc full colors.
#define SPACEMETER_FULLBORDERCOLOR			RGB(153,0,0)
#define SPACEMETER_FULLBARCOLOR_FREETOP		RGB(255,197,177)
#define SPACEMETER_FULLBARCOLOR_FREEBOTTOM	RGB(255,255,255)
#define SPACEMETER_FULLBARCOLOR_TOP			RGB(255,121,75)
#define SPACEMETER_FULLBARCOLOR_BOTTOM		RGB(255,51,0)*/
