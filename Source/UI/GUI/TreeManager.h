...
#define PROJECTITEM_FLAG_ISBOOTIMAGE				4
#define PROJECTITEM_FLAG_ISIMPORTED					8
#define PROJECTITEM_FLAG_ISDVDVIDEO					16
#define PROJECTITEM_FLAG_ISPROJECTROOT				32
