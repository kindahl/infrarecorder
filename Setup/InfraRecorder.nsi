...
;Language Strings
  ...
  LangString NAME_SecCore ${LANG_RUSSIAN} "InfraRecorder основные файлы (требуютс€)"
  LangString NAME_SecStartShortcut ${LANG_RUSSIAN} "ярлык в меню ѕуск"
  LangString NAME_SecDeskShortcut ${LANG_RUSSIAN} "ярлык на –абочем столе"
  LangString NAME_SecQuickShortcut ${LANG_RUSSIAN} "ярлык на панели Ѕыстрый запуск"
  LangString NAME_SecLang ${LANG_RUSSIAN} "языковые файлы"
  LangString DESC_SecCore ${LANG_RUSSIAN} "‘айлы необходимые дл€ работы InfraRecorder."
  LangString DESC_SecStartShortcut ${LANG_RUSSIAN} "ƒобавл€ет €рлык в меню ѕуск дл€ быстрого доступа."
  LangString DESC_SecDeskShortcut ${LANG_RUSSIAN} "ƒобавл€ет €рлык на –абочий стол."
  LangString DESC_SecQuickShortcut ${LANG_RUSSIAN} "ƒобавл€ет €рлык на панель Ѕыстрый запуск."
  LangString DESC_SecLang ${LANG_RUSSIAN} "языковые файлы, используемые дл€ поддержки других €зыков в InfraRecorder."
