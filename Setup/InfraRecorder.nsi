...
;Language Strings
  ...
  LangString NAME_SecCore ${LANG_BULGARIAN} "Основни файлове на InfraRecorder (задължително)"
  LangString NAME_SecStartShortcut ${LANG_BULGARIAN} "Преки пътища в меню Старт"
  LangString NAME_SecDeskShortcut ${LANG_BULGARIAN} "Пряк път до работния плот"
  LangString NAME_SecQuickShortcut ${LANG_BULGARIAN} "Пряк път до лентата quick launch"
  LangString NAME_SecLang ${LANG_BULGARIAN} "Файлове за езиците"
  LangString DESC_SecCore ${LANG_BULGARIAN} "Основни файлове изискващи се при използването на InfraRecorder"
  LangString DESC_SecStartShortcut ${LANG_BULGARIAN} "Добавяне на икони в меню Старт за лесен достъп."
  LangString DESC_SecDeskShortcut ${LANG_BULGARIAN} "Добавяне на икони на вашия работен плот"
  LangString DESC_SecQuickShortcut ${LANG_BULGARIAN} "Добавяне на икони в лентата quick launch"
  LangString DESC_SecLang ${LANG_BULGARIAN} "Файлове на езиците използвани за поддръжка на различни езици в InfraRecorder"
  ...
  LangString DESC_SecCore ${LANG_CROATIAN} "Jezgrene datoteke nuћne za upotrebu InfraRecorder."
  LangString DESC_SecStartShortcut ${LANG_CROATIAN} "Dodaje ikoneu Start meni radi lakљeg pokretanja."
  LangString DESC_SecDeskShortcut ${LANG_CROATIAN} "Dodaje ikonu na vaљ desktop."
  LangString DESC_SecQuickShortcut ${LANG_CROATIAN} "Dodaje ikonu u vaљ Quick Launch liniju."
  LangString DESC_SecLang ${LANG_CROATIAN} "Datoteke jezika koriљtene za razlicite prijevode InfraRecorder-a."
  ...
  LangString NAME_SecDeskShortcut ${LANG_CZECH} "Zбstupce na Ploљe"
  LangString NAME_SecQuickShortcut ${LANG_CZECH} "Zбstupce v panelu Snadnй spuљtмnн"
  LangString NAME_SecLang ${LANG_CZECH} "Jazykovй soubory"
  LangString DESC_SecCore ${LANG_CZECH} "Zбkladnн soubory potшebnй ke spuљtмnн InfraRecorderu."
  ...
  LangString DESC_SecQuickShortcut ${LANG_CZECH} "Pшidб ikonu do panelu Snadnйho spuљtмnн."
  LangString DESC_SecLang ${LANG_CZECH} "Jazykovй soubory zajiљќujнcн InfraRecorderu podporu rщznэch jazykщ."
  ...
  LangString NAME_SecCore ${LANG_FINNISH} "InfraRecorder Core Files (required)"
  LangString NAME_SecStartShortcut ${LANG_FINNISH} "Start Menu Shortcuts"
  LangString NAME_SecDeskShortcut ${LANG_FINNISH} "Desktop Shortcut"
  LangString NAME_SecQuickShortcut ${LANG_FINNISH} "Quick Launch Shortcut"
  LangString NAME_SecLang ${LANG_FINNISH} "Language Files"
  LangString DESC_SecCore ${LANG_FINNISH} "The core files required to use InfraRecorder."
  LangString DESC_SecStartShortcut ${LANG_FINNISH} "Adds icons to your start menu for easy access."
  LangString DESC_SecDeskShortcut ${LANG_FINNISH} "Adds an icon to your desktop."
  LangString DESC_SecQuickShortcut ${LANG_FINNISH} "Adds an icon to your quick launch bar."
  LangString DESC_SecLang ${LANG_FINNISH} "Language files used for supporting different languages in InfraRecorder."
  ...
  LangString NAME_SecCore ${LANG_HUNGARIAN} "InfraRecorder Core Files (required)"
  LangString NAME_SecStartShortcut ${LANG_HUNGARIAN} "Start Menu Shortcuts"
  LangString NAME_SecDeskShortcut ${LANG_HUNGARIAN} "Desktop Shortcut"
  LangString NAME_SecQuickShortcut ${LANG_HUNGARIAN} "Quick Launch Shortcut"
  LangString NAME_SecLang ${LANG_HUNGARIAN} "Language Files"
  LangString DESC_SecCore ${LANG_HUNGARIAN} "The core files required to use InfraRecorder."
  LangString DESC_SecStartShortcut ${LANG_HUNGARIAN} "Adds icons to your start menu for easy access."
  LangString DESC_SecDeskShortcut ${LANG_HUNGARIAN} "Adds an icon to your desktop."
  LangString DESC_SecQuickShortcut ${LANG_HUNGARIAN} "Adds an icon to your quick launch bar."
  LangString DESC_SecLang ${LANG_HUNGARIAN} "Language files used for supporting different languages in InfraRecorder."
  ...
  LangString NAME_SecCore ${LANG_JAPANESE} "InfraRecorder –{‘Мѓtѓ@ѓCѓ‹ (•Kђ{)"
  LangString NAME_SecStartShortcut ${LANG_JAPANESE} "[ѓXѓ^Ѓ[ѓg] ѓЃѓjѓ…Ѓ[ ѓVѓ‡Ѓ[ѓgѓJѓbѓg"
  LangString NAME_SecDeskShortcut ${LANG_JAPANESE} "ѓfѓXѓNѓgѓbѓv ѓVѓ‡Ѓ[ѓgѓJѓbѓg"
  LangString NAME_SecQuickShortcut ${LANG_JAPANESE} "[ѓNѓCѓbѓN‹N“®] ѓVѓ‡Ѓ[ѓgѓJѓbѓg"
  LangString NAME_SecLang ${LANG_JAPANESE} "ЊѕЊкѓtѓ@ѓCѓ‹"
  LangString DESC_SecCore ${LANG_JAPANESE} "–{‘Мѓtѓ@ѓCѓ‹‚Н InfraRecorder ‚рЋg—p‚·‚й‚М‚Й•K—v‚Е‚·ЃB"
  LangString DESC_SecStartShortcut ${LANG_JAPANESE} "ЉИ’P‚ИѓAѓNѓZѓX‚М‚Ѕ‚Я‚ЙѓAѓCѓRѓ“‚р‚ЁЋg‚ў‚М [ѓXѓ^Ѓ[ѓg] ѓЃѓjѓ…Ѓ[‚Й’З‰Б‚µ‚Ь‚·ЃB"
  LangString DESC_SecDeskShortcut ${LANG_JAPANESE} "ѓAѓCѓRѓ“‚р‚ЁЋg‚ў‚МѓfѓXѓNѓgѓbѓv‚Й’З‰Б‚µ‚Ь‚·ЃB"
  LangString DESC_SecQuickShortcut ${LANG_JAPANESE} "ѓAѓCѓRѓ“‚р‚ЁЋg‚ў‚М [ѓNѓCѓbѓN‹N“®] ѓoЃ[‚Й’З‰Б‚µ‚Ь‚·ЃB"
  LangString DESC_SecLang ${LANG_JAPANESE} "ЊѕЊкѓtѓ@ѓCѓ‹‚Н InfraRecorder ‚р€Щ‚И‚Б‚ЅЊѕЊк‚ЕѓTѓ|Ѓ[ѓg‚·‚й‚М‚ЙЋg—p‚і‚к‚Ь‚·ЃB"
  ...
  LangString DESC_SecCore ${LANG_NORWEGIAN} "Kjernefiler som kreves for е kjшre InfraRecorder"
  ...
  LangString DESC_SecLang ${LANG_NORWEGIAN} "Sprеkfiler tillater bruk av ulike sprеk i InfraRecorder"

  ;Language strings (Polish)
  LangString NAME_SecCore ${LANG_POLISH} "Gіуwne pliki InfraRecorder (wymagane)"
  ...
  LangString DESC_SecCore ${LANG_POLISH} "Gіуwne pliki wymagane przez InfraRecorder."
  ...
  LangString DESC_SecLang ${LANG_POLISH} "Pliki jкzykowe dla obsіugi innych jкzykуw w InfraRecorder."
  ...
  LangString NAME_SecStartShortcut ${LANG_SERBIAN} "Пречица Старт менија"
  LangString NAME_SecDeskShortcut ${LANG_SERBIAN} "Пречица радне површине"
  LangString NAME_SecQuickShortcut ${LANG_SERBIAN} "Пречица брзог покретања"
  LangString NAME_SecLang ${LANG_SERBIAN} "Језичке датотеке"
  LangString DESC_SecCore ${LANG_SERBIAN} "Датотеке за рад InfraRecorder-а."
  LangString DESC_SecStartShortcut ${LANG_SERBIAN} "Додај иконе у старт менију за лакши приступ."
  LangString DESC_SecDeskShortcut ${LANG_SERBIAN} "Додај икону на радној површини."
  LangString DESC_SecQuickShortcut ${LANG_SERBIAN} "Додај икону на траку брзог покретања."
  LangString DESC_SecLang ${LANG_SERBIAN} "Језичке датотеке за InfraRecorder."
  ...
  LangString NAME_SecDeskShortcut ${LANG_SERBIANLATIN} "Preиica radne povrљine"
  ...
  LangString DESC_SecStartShortcut ${LANG_SERBIANLATIN} "Dodaj ikone u start meniju za lakљi pristup."
  LangString DESC_SecDeskShortcut ${LANG_SERBIANLATIN} "Dodaj ikonu na radnoj povrљini."
  ...
  LangString NAME_SecStartShortcut ${LANG_SLOVAK} "Odkazy v menu Љtart"
  ...
  LangString DESC_SecCore ${LANG_SLOVAK} "Zбkladnй sъbory nutnй na pouћнvanie InfraRecorderu"
  LangString DESC_SecStartShortcut ${LANG_SLOVAK} "Pridб ikony do ponuky Љtart pre zjednoduљnie prнstupu."
  LangString DESC_SecDeskShortcut ${LANG_SLOVAK} "Pridб ikonu na Plochu"
  LangString DESC_SecQuickShortcut ${LANG_SLOVAK} "Pridб ikonu do Vбљho panelu Rэchle spustenie."
  LangString DESC_SecLang ${LANG_SLOVAK} "Sъbory jazykov, pouћitй pre podporu rфznych jazykov InfraRecorderu"
  ...
  LangString NAME_SecCore ${LANG_TRADCHINESE} "InfraRecorder®Ц¤ЯАЙ®Ч(ҐІ­n¦wёЛ)"
  LangString NAME_SecStartShortcut ${LANG_TRADCHINESE} "¶}©lҐ\ЇаЄн±¶®|"
  LangString NAME_SecDeskShortcut ${LANG_TRADCHINESE} "®а­±±¶®|"
  LangString NAME_SecQuickShortcut ${LANG_TRADCHINESE} "§Ціt±Т°К±¶®|"
  LangString NAME_SecLang ${LANG_TRADCHINESE} "»yЁҐАЙ®Ч"
  LangString DESC_SecCore ${LANG_TRADCHINESE} "InfraRecorder°х¦ж®Й©Т»ЭЄє®Ц¤ЯАЙ®Ч."
  LangString DESC_SecStartShortcut ${LANG_TRADCHINESE} "јWҐ[№ПҐЬ¦Ь¶}©lҐ\ЇаЄн."
  LangString DESC_SecDeskShortcut ${LANG_TRADCHINESE} "јWҐ[№ПҐЬ¦Ь®а­±."
  LangString DESC_SecQuickShortcut ${LANG_TRADCHINESE} "јWҐ[№ПҐЬ¦Ь§Ціt±Т°К."
  LangString DESC_SecLang ${LANG_TRADCHINESE} "ЕэInfraRecorderҐiҐHЕгҐЬ¤Ј¦P°к®a»yЁҐЄєҐ\ЇаЄн."

  ;Language strings (Turkish)
  LangString NAME_SecCore ${LANG_TURKISH} "InfraRecorder yapэlandэrma dosyalarэ (gereklidir)"
  LangString NAME_SecStartShortcut ${LANG_TURKISH} "Baюlat menьsь kэsa yollarэ"
  LangString NAME_SecDeskShortcut ${LANG_TURKISH} "Masaьstь kэsa yolu"
  LangString NAME_SecQuickShortcut ${LANG_TURKISH} "Hэzlэ Baюlat kэsayolu"
  LangString NAME_SecLang ${LANG_TURKISH} "Dil dosyalarэ"
  LangString DESC_SecCore ${LANG_TURKISH} "Yapэlandэrma dosyalarэ InfraRecorder kullanэmэ iзin gereklidir"
  LangString DESC_SecStartShortcut ${LANG_TURKISH} "Kolay eriюim iзin Baюlat menьsь'ne simge ekle."
  LangString DESC_SecDeskShortcut ${LANG_TURKISH} "Masaьstь'ne simge ekle."
  LangString DESC_SecQuickShortcut ${LANG_TURKISH} "Hэzlэ Baюlat зubuрuna simge ekle."
  LangString DESC_SecLang ${LANG_TURKISH} "InfraRecorder'эn farklэ dilleri desteklemesi iзin dil dosyalarэnэ kullan."

  ;Language strings (Ukrainian)
  LangString NAME_SecCore ${LANG_UKRAINIAN} "Основні файли InfraRecorder (необхідно)"
  LangString NAME_SecStartShortcut ${LANG_UKRAINIAN} "Ярлички для меню 'Пуск'"
  LangString NAME_SecDeskShortcut ${LANG_UKRAINIAN} "Ярличок на робочий стіл"
  LangString NAME_SecQuickShortcut ${LANG_UKRAINIAN} "Ярличок для меню швидкого запуску"
  LangString NAME_SecLang ${LANG_UKRAINIAN} "Мовні файли"
  LangString DESC_SecCore ${LANG_UKRAINIAN} "Основні файли потрібні для роботи InfraRecorder."
  LangString DESC_SecStartShortcut ${LANG_UKRAINIAN} "Додає іконки до Вашого меню 'Пуск' щоб полегшити доступ..."
  LangString DESC_SecDeskShortcut ${LANG_UKRAINIAN} "Додає іконку до Вашого робочого столу."
...
Section $(NAME_SecStartShortcut) SecStartShortcut
  ...
  CreateShortCut "$SMPROGRAMS\InfraRecorder\InfraExpress.lnk" "$INSTDIR\irExpress.exe"
