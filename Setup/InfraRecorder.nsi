...
;Language Strings
  ...
  LangString NAME_SecQuickShortcut ${LANG_TRADCHINESE} "§Ціt±Т°КјдІb"
  LangString NAME_SecLang ${LANG_TRADCHINESE} "»yЁҐАЙ®Ч"
  LangString DESC_SecCore ${LANG_TRADCHINESE} "°х¦ж InfraRecorder ©Т»Э­nЄє®Ц¤ЯАЙ®Ч"
  ...
  LangString DESC_SecLang ${LANG_TRADCHINESE} "Еэ InfraRecorder ¤дґ©¤Ј¦P°к®aЄє»yЁҐ"
